...
class TestSetupUi : MainActivityUiTestFixtures() {
    ...
    fun setupGameInformation() {
        ...
        composeRule.onNodeWithTag("setup-game-level-other").performClick()
        composeRule.onNodeWithTag("setup-game-level-NA").performClick()
        composeRule.onNodeWithTag("setup-game-level-other").performClick()
        ...
        composeRule.onNodeWithTag("setup-game-level-other").assertIsSelected()
        composeRule.onNodeWithTag("setup-game-level-College").assertIsNotSelected()
