...
This page gives the shortest path from opening UltiObserver to being able to use it
for observing a game.  Later pages describe each screen in more detail.
...
4. Choose appropriate colors if you want -- probably their jersey colors.
5. Open **Game information** to enter the scheduled start time. The default is the next even
   half hour after the current time.
...
8. When you bring the teams together for the pre-game flip, record the results in the
   **Field/starting pull** section. This includes which team is pulling, from which end
   ...
   timing prompts. For mixed division, the initial gender ratio is also recorded here.
9. Tap **Start game** to start the game.

During The Game
---------------

Use the active game screen for common actions during the game.

* Any active countdown will be shown at the top of the screen, along with cues for what you
...
When the game is over, UltiObserver shows a summary of the completed game. From there you can:
